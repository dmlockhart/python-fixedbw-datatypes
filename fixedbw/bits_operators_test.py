#=======================================================================
# bits_operators_test.py
#=======================================================================

import pytest

from Bits import Bits
from bits_operators import (
  nbits, clog2, concat, zext, sext,
...
def test_nbits():
  ...
  assert nbits( 0x000f ) == 4
  assert nbits( 0x00ff ) == 8
  assert nbits( 0x0fff ) == 12
  assert nbits( 0xffff ) == 16
